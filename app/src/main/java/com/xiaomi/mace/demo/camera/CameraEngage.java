...
//    private static final int FINAL_SIZE = 224;
    private static final int FINAL_SIZE_WIDTH = 224;  // madhu
    private static final int FINAL_SIZE_HEIGHT = 224; // madhu
    /**
     * storage rgb value
     */
...
//            Bitmap bitmap = mTextureView.getBitmap(FINAL_SIZE, FINAL_SIZE);
            Bitmap bitmap = mTextureView.getBitmap(FINAL_SIZE_WIDTH, FINAL_SIZE_HEIGHT);
            if (bitmap != null) {
...
//        floatBuffer = FloatBuffer.wrap(floatValues, 0, FINAL_SIZE * FINAL_SIZE * 3);
        ...
        colorValues = new int[FINAL_SIZE_WIDTH * FINAL_SIZE_HEIGHT];
        float[] floatValues = new float[FINAL_SIZE_WIDTH * FINAL_SIZE_HEIGHT * 3];
        floatBuffer = FloatBuffer.wrap(floatValues, 0, FINAL_SIZE_WIDTH * FINAL_SIZE_WIDTH * 3);
